...
**Current version `0.1.20260627`** — alpha; expect breaking churn. Five alpha tracks live in `main` alongside stable v0.1: **Cohort Dashboard**, **Cloud-share** (parked — see ROADMAP), **in-app TSV/text editors**, **Merge datasets**, **Task events**. Per-track scope, locked decisions, and history: [ROADMAP.md](ROADMAP.md) + `git log`.
